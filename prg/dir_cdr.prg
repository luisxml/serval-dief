...
*!*					oFSO.DeleteFolder("D:\SFS_v1.3.2_DIEF\sunat_archivos\sfs\RPTA\dummy",.t.) 
                   
                cMiZip 	  =   taFiles(lnFileCount)
				cDirDesti = '\\'+Vpc_server+'\SFS_v1.3.2_DIEF\sunat_archivos\sfs\RPTA\'
...
*!*	                oFSO = CREATEOBJECT("Scripting.FileSystemObject") 
*!*					oFSO.DeleteFolder('\\'+Vpc_server+'\SFS_v1.3.2_DIEF\sunat_archivos\sfs\RPTA\dummy',.t.) 		
				
				Vlc_dir = DIRECTORY('\\'+Vpc_server+'\SFS_v1.3.2_DIEF\sunat_archivos\sfs\RPTA\dummy')							
				IF Vlc_dir = .t.
                	oFSO = CREATEOBJECT("Scripting.FileSystemObject") 
					oFSO.DeleteFolder('\\'+Vpc_server+'\SFS_v1.3.2_DIEF\sunat_archivos\sfs\RPTA\dummy',.t.) 		
				ENDIF		
